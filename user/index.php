    ...
    <section class="sidebar">
     ...
     <div>&nbsp;</div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="index.php?p=tambahtrouble">
            <i class="fa fa-warning"></i> <span>Laporkan Troubleshoot</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
...
<?php
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 Panel Admin - Help Desk Living World IT Officer Division Pekanbaru</strong> All rights
    reserved.
  </footer>
