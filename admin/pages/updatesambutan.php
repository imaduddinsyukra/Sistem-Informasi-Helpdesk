 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="index.php?p=updatesambutan"><i class="fa fa-pencil"></i> Update Sambutan Kepala Sekolah</a></li>
      </ol>
    </section>
 <!-- Main content -->
        ...
        <div class="col-md-12">           
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Update Sambutan Kepala Sekolah
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
              <form method="POST" action="index.php?p=prosesupdatesambutan">
