    ...
    <section class="sidebar">
     ...
     <div>&nbsp;</div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php?p=pilihlaporan" target="blank"><i class="fa fa-print"></i> Laporan</a></li>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<?php
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 Panel User - Help Desk Living World IT Officer Division Pekanbaru</strong> All rights
    reserved.
  </footer>
